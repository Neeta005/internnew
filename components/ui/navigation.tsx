...
export function Navigation({ items, showAuthButtons = true, userProfile }: NavigationProps) {
  return (
    <nav className="flex items-center px-6 py-4 bg-gradient-to-r from-slate-900 to-slate-800 border-b border-slate-700/50">
      {/* Logo Section */}
      <div className="flex items-center">
        <Logo />
      </div>
      
      {/* Navigation Links - Left side after logo */}
      ...
      {/* Spacer to push right content to far right */}
