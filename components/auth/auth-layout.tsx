  ...
  return (
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        {/* Modal Card */}
        <div className="bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden max-w-4xl w-full">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 relative overflow-hidden">
              ...
              {/* Student Image - shifted slightly right */}
              <div className="relative bg-gradient-to-br from-yellow-400 to-orange-500 aspect-[4/3] lg:aspect-[4/5]">
                <Image
                  ...
                  // 👆 moves the image slightly to the right (~5%)
                  priority
            ...
            <div className="lg:w-1/2 p-8 lg:p-12 bg-slate-800">{children}</div>
          </div>
        </div>
      </div>
    </div>
