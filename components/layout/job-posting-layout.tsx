...
import { jobPostingSteps } from "@/lib/job-posting-data"
...
export function JobPostingLayout({
  ...
  const currentSteps = jobPostingSteps.map((step, index) => ({
    ...step,
    completed: index < currentStep,
  }))

  const progressPercentage = ((currentStep + 1) / jobPostingSteps.length) * 100
