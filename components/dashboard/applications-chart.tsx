  ...
  return (
    <Card className="bg-slate-800 border-slate-700">
      ...
      <CardContent className="pt-0 relative">
        {/* Y-axis labels */}
        <div className="absolute left-0 top-4 h-56 flex flex-col justify-between text-xs text-gray-400 z-10">
          <span>100</span>
          <span>80</span>
          <span>60</span>
          <span>40</span>
        ...
        <div className="h-72 flex items-end justify-between pl-8 pr-4">
          {data.map((item, index) => {
            const maxValue = 100
